...
export const Header = () => {
    ...
    return (
        <header className="flex flex-row justify-around items-center p-6 bg-[#252422]">
            ...
            <div
                className={`fixed top-0 left-0 h-full w-64 bg-white transform transition-all md:relative md:flex md:items-center md:gap-x-6 md:w-auto md:bg-transparent ${
                    isOpen ? 'translate-x-0' : '-translate-x-full'
                } md:translate-x-0`}
            >
                <button
                    className="absolute top-0 right-0 m-6 md:hidden"
                    onClick={toggleMenu}
                >
                ...
                <ul className="flex flex-col gap-y-6 p-6 text-black md:flex-row md:gap-x-6 md:p-0 md:text-white md:ml-auto md:mr-auto">
                    ...
                    <li>
                        <a
                            href="/contact"
                            className="bg-[#EB5E28] rounded-full px-4 py-3 md:hidden"
                        >
                            Nous contacter
                        </a>
                    </li>
